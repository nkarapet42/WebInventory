...
namespace WebInventory.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260508071406_AddSearchVectors")]
            ...
            modelBuilder.Entity("WebInventory.Domain.Entities.Inventory", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("to_tsvector('simple', coalesce(\"Title\", '') || ' ' || coalesce(\"DescriptionMarkdown\", ''))", true);
            ...
            modelBuilder.Entity("WebInventory.Domain.Entities.Item", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("tsvector")
                        .HasComputedColumnSql("to_tsvector('simple', coalesce(\"CustomId\", '') || ' ' || coalesce(\"Text1\", '') || ' ' || coalesce(\"Text2\", '') || ' ' || coalesce(\"Text3\", ''))", true);
